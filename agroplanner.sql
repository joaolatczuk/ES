...
-- Copiando dados para a tabela agroplanner.conteudos: ~5 rows (aproximadamente)
INSERT INTO `conteudos` (`id`, `nomePlanta`, `categoria`, `epoca`, `temperatura`, `solo`, `rega`, `sol`, `instrucoes`, `id_autor`, `data_publicacao`, `status`, `favorita`, `statusAtivo`) VALUES
	...
	(10, '123', 'Fruta', 'Verão', '5', 'Argiloso', '4 dia', 'Meia sombra – algumas horas com luz direta', '123', 1, '2025-06-07 17:00:31', 'pendente', 0, 0),
	(11, '123', 'Flor', 'Primavera', '8', 'Arenoso', '8 dia', 'Sol pleno o dia todo', '123', 1, '2025-06-08 11:54:51', 'pendente', 0, 1),
	(12, '123', 'Fruta', 'Verão', '22', 'Humoso', '7 semana', 'Sombra – luz indireta, sem sol direto', '3312ljhpiahpauPIUHPI', 1, '2025-06-08 11:55:26', 'pendente', 0, 1),
	(13, '123', 'Raiz', 'Verão', '13', 'Humoso', '4 mês', 'Pleno sol – mínimo de 4h de sol direto', 'IODUOIUiouaposuiipsauoOIUP', 1, '2025-06-08 11:56:00', 'aprovado', 0, 1);
...
-- Copiando dados para a tabela agroplanner.imagens_conteudo: ~5 rows (aproximadamente)
INSERT INTO `imagens_conteudo` (`id`, `id_conteudo`, `url`) VALUES
	...
	(9, 11, '/uploads/1749394491423-girassol-2-scaled.jpg'),
	(10, 12, '/uploads/1749394526604-sementes_de_margarida_gigante_branca_1467_sementes_2513_1_1f0e3931c1faf127987e5d683f6e9f2b.jpg'),
	(11, 13, '/uploads/1749394560026-Papoula.jpg');
